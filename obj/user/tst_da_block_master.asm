...
obj/user/tst_da_block_master:     file format elf32-i386
...
_main(void)
{
  ...
  800048:	68 f3 1b 80 00       	push   $0x801bf3
...
libmain(int argc, char **argv)
{
  ...
  8000d5:	bb 08 1d 80 00       	mov    $0x801d08,%ebx
  ...
  80011a:	68 28 1c 80 00       	push   $0x801c28
  ...
  800136:	50                   	push   %eax
  800137:	68 50 1c 80 00       	push   $0x801c50
  ...
  80015f:	52                   	push   %edx
  800160:	50                   	push   %eax
  800161:	68 74 1c 80 00       	push   $0x801c74
  ...
  800190:	52                   	push   %edx
  800191:	50                   	push   %eax
  800192:	68 9c 1c 80 00       	push   $0x801c9c
  ...
  8001ad:	50                   	push   %eax
  8001ae:	68 f4 1c 80 00       	push   $0x801cf4
  8001b3:	e8 18 03 00 00       	call   8004d0 <cprintf>
  8001b8:	83 c4 10             	add    $0x10,%esp
			cprintf("**************************************\n");
  8001bb:	83 ec 0c             	sub    $0xc,%esp
  8001be:	68 28 1c 80 00       	push   $0x801c28
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800222:	50                   	push   %eax
  800223:	68 6c 1d 80 00       	push   $0x801d6c
  ...
  80023e:	50                   	push   %eax
  80023f:	68 74 1d 80 00       	push   $0x801d74
  ...
  800265:	68 9c 1d 80 00       	push   $0x801d9c
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800294:	68 a0 1d 80 00       	push   $0x801da0
  800299:	6a 26                	push   $0x26
  80029b:	68 ec 1d 80 00       	push   $0x801dec
  ...
  800369:	68 f8 1d 80 00       	push   $0x801df8
  80036e:	6a 3a                	push   $0x3a
  800370:	68 ec 1d 80 00       	push   $0x801dec
  ...
  8003dc:	68 4c 1e 80 00       	push   $0x801e4c
  8003e1:	6a 44                	push   $0x44
  8003e3:	68 ec 1d 80 00       	push   $0x801dec
...
static void putch(int ch, struct printbuf *b) {
  ...
  80041c:	8b 15 1c b1 81 00    	mov    0x81b11c,%edx
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800495:	83 c4 10             	add    $0x10,%esp
	sys_cputs(b.buf, b.idx, printProgName, curTextClr);
  800498:	8b 15 1c b1 81 00    	mov    0x81b11c,%edx
...
int cprintf_colored(int textClr, const char *fmt, ...) {
  ...
  800510:	a3 1c b1 81 00       	mov    %eax,0x81b11c
	va_start(ap, fmt);
  ...
  800533:	c7 05 1c b1 81 00 00 	movl   $0x700,0x81b11c
  80053a:	07 00 00 
...
uint32 sys_get_uheap_strategy()
{
  ...
  801825:	a3 60 b0 81 00       	mov    %eax,0x81b060
	return uheapPlaceStrategy ;
  80182a:	a1 60 b0 81 00       	mov    0x81b060,%eax
}
  80182f:	c9                   	leave  
  801830:	c3                   	ret    
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801837:	a3 60 b0 81 00       	mov    %eax,0x81b060
