...
libmain(int argc, char **argv)
{
  ...
  800252:	8b 90 ac 05 00 00    	mov    0x5ac(%eax),%edx
  ...
  80027a:	8b 88 c0 05 00 00    	mov    0x5c0(%eax),%ecx
  800280:	a1 20 30 80 00       	mov    0x803020,%eax
  800285:	8b 90 bc 05 00 00    	mov    0x5bc(%eax),%edx
  80028b:	a1 20 30 80 00       	mov    0x803020,%eax
  800290:	8b 80 b8 05 00 00    	mov    0x5b8(%eax),%eax
  800296:	51                   	push   %ecx
  800297:	52                   	push   %edx
  800298:	50                   	push   %eax
  ...
  8002ab:	8b 80 c4 05 00 00    	mov    0x5c4(%eax),%eax
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  801a58:	52                   	push   %edx
  801a59:	50                   	push   %eax
  801a5a:	6a 2e                	push   $0x2e
  801a5c:	e8 5b fa ff ff       	call   8014bc <syscall>
