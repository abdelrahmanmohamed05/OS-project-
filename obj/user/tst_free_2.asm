...
libmain(int argc, char **argv)
{
  ...
  8000fa:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  ...
  80015d:	bb e8 1d 80 00       	mov    $0x801de8,%ebx
  ...
  8001a2:	68 08 1d 80 00       	push   $0x801d08
  ...
  8001be:	50                   	push   %eax
  8001bf:	68 30 1d 80 00       	push   $0x801d30
  ...
  8001d3:	8b 90 ac 05 00 00    	mov    0x5ac(%eax),%edx
  8001d9:	a1 40 30 80 00       	mov    0x803040,%eax
  8001de:	8b 80 9c 05 00 00    	mov    0x59c(%eax),%eax
  8001e4:	83 ec 04             	sub    $0x4,%esp
  8001e7:	52                   	push   %edx
  8001e8:	50                   	push   %eax
  8001e9:	68 54 1d 80 00       	push   $0x801d54
  8001ee:	e8 65 03 00 00       	call   800558 <cprintf>
  8001f3:	83 c4 10             	add    $0x10,%esp
				cprintf("# PAGE IN (from disk) = %d, # PAGE OUT (on disk) = %d, # NEW PAGE ADDED (on disk) = %d\n", myEnv->nPageIn, myEnv->nPageOut,myEnv->nNewPageAdded);
  8001f6:	a1 40 30 80 00       	mov    0x803040,%eax
  8001fb:	8b 88 c0 05 00 00    	mov    0x5c0(%eax),%ecx
  800201:	a1 40 30 80 00       	mov    0x803040,%eax
  800206:	8b 90 bc 05 00 00    	mov    0x5bc(%eax),%edx
  80020c:	a1 40 30 80 00       	mov    0x803040,%eax
  800211:	8b 80 b8 05 00 00    	mov    0x5b8(%eax),%eax
  800217:	51                   	push   %ecx
  800218:	52                   	push   %edx
  800219:	50                   	push   %eax
  80021a:	68 7c 1d 80 00       	push   $0x801d7c
  ...
  80022c:	8b 80 c4 05 00 00    	mov    0x5c4(%eax),%eax
  800232:	83 ec 08             	sub    $0x8,%esp
  800235:	50                   	push   %eax
  800236:	68 d4 1d 80 00       	push   $0x801dd4
  80023b:	e8 18 03 00 00       	call   800558 <cprintf>
  800240:	83 c4 10             	add    $0x10,%esp
			cprintf("**************************************\n");
  800243:	83 ec 0c             	sub    $0xc,%esp
  800246:	68 08 1d 80 00       	push   $0x801d08
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8002aa:	50                   	push   %eax
  8002ab:	68 4c 1e 80 00       	push   $0x801e4c
  ...
  8002c6:	50                   	push   %eax
  8002c7:	68 54 1e 80 00       	push   $0x801e54
  ...
  8002ed:	68 7c 1e 80 00       	push   $0x801e7c
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  80031c:	68 80 1e 80 00       	push   $0x801e80
  800321:	6a 26                	push   $0x26
  800323:	68 cc 1e 80 00       	push   $0x801ecc
  ...
  8003f1:	68 d8 1e 80 00       	push   $0x801ed8
  8003f6:	6a 3a                	push   $0x3a
  8003f8:	68 cc 1e 80 00       	push   $0x801ecc
  ...
  800464:	68 2c 1f 80 00       	push   $0x801f2c
  800469:	6a 44                	push   $0x44
  80046b:	68 cc 1e 80 00       	push   $0x801ecc
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  8019d9:	52                   	push   %edx
  8019da:	50                   	push   %eax
  8019db:	6a 2e                	push   $0x2e
  8019dd:	e8 5b fa ff ff       	call   80143d <syscall>
