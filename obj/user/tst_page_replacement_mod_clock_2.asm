...
static void putch(int ch, struct printbuf *b) {
  ...
  800422:	a0 60 f0 80 00       	mov    0x80f060,%al
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  80049e:	a0 60 f0 80 00       	mov    0x80f060,%al
  ...
  8004be:	83 c4 10             	add    $0x10,%esp
	...
	printProgName = 0;
  8004c1:	c6 05 60 f0 80 00 00 	movb   $0x0,0x80f060
	return b.cnt;
...
int cprintf(const char *fmt, ...) {
  ...
  8004d3:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  8004d6:	c6 05 60 f0 80 00 01 	movb   $0x1,0x80f060
	va_start(ap, fmt);
...
int cprintf_colored(int textClr, const char *fmt, ...) {
  ...
  800500:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  800503:	c6 05 60 f0 80 00 01 	movb   $0x1,0x80f060
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800a86:	eb 35                	jmp    800abd <vprintfmt+0x3ce>
		...
		case '~':
			printProgName = 0;
  800a88:	c6 05 60 f0 80 00 00 	movb   $0x0,0x80f060
			break;
  800a8f:	eb 2c                	jmp    800abd <vprintfmt+0x3ce>
		// Print Program Name & UD
		case '@':
			printProgName = 1;
  800a91:	c6 05 60 f0 80 00 01 	movb   $0x1,0x80f060
			break;
