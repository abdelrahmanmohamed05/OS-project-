...
void _main(void)
{
  ...
  80005d:	68 50 1c 80 00       	push   $0x801c50
...
libmain(int argc, char **argv)
{
  ...
  800087:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  ...
  8000ea:	bb 6c 1d 80 00       	mov    $0x801d6c,%ebx
  ...
  80012f:	68 8c 1c 80 00       	push   $0x801c8c
  ...
  80014b:	50                   	push   %eax
  80014c:	68 b4 1c 80 00       	push   $0x801cb4
  ...
  800160:	8b 90 ac 05 00 00    	mov    0x5ac(%eax),%edx
  800166:	a1 20 30 80 00       	mov    0x803020,%eax
  80016b:	8b 80 9c 05 00 00    	mov    0x59c(%eax),%eax
  800171:	83 ec 04             	sub    $0x4,%esp
  800174:	52                   	push   %edx
  800175:	50                   	push   %eax
  800176:	68 d8 1c 80 00       	push   $0x801cd8
  80017b:	e8 65 03 00 00       	call   8004e5 <cprintf>
  800180:	83 c4 10             	add    $0x10,%esp
				cprintf("# PAGE IN (from disk) = %d, # PAGE OUT (on disk) = %d, # NEW PAGE ADDED (on disk) = %d\n", myEnv->nPageIn, myEnv->nPageOut,myEnv->nNewPageAdded);
  800183:	a1 20 30 80 00       	mov    0x803020,%eax
  800188:	8b 88 c0 05 00 00    	mov    0x5c0(%eax),%ecx
  80018e:	a1 20 30 80 00       	mov    0x803020,%eax
  800193:	8b 90 bc 05 00 00    	mov    0x5bc(%eax),%edx
  800199:	a1 20 30 80 00       	mov    0x803020,%eax
  80019e:	8b 80 b8 05 00 00    	mov    0x5b8(%eax),%eax
  8001a4:	51                   	push   %ecx
  8001a5:	52                   	push   %edx
  8001a6:	50                   	push   %eax
  ...
  8001b9:	8b 80 c4 05 00 00    	mov    0x5c4(%eax),%eax
  8001bf:	83 ec 08             	sub    $0x8,%esp
  8001c2:	50                   	push   %eax
  8001c3:	68 58 1d 80 00       	push   $0x801d58
  8001c8:	e8 18 03 00 00       	call   8004e5 <cprintf>
  8001cd:	83 c4 10             	add    $0x10,%esp
			cprintf("**************************************\n");
  8001d0:	83 ec 0c             	sub    $0xc,%esp
  8001d3:	68 8c 1c 80 00       	push   $0x801c8c
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800237:	50                   	push   %eax
  800238:	68 d0 1d 80 00       	push   $0x801dd0
  ...
  80027a:	68 00 1e 80 00       	push   $0x801e00
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  8002a9:	68 04 1e 80 00       	push   $0x801e04
  8002ae:	6a 26                	push   $0x26
  8002b0:	68 50 1e 80 00       	push   $0x801e50
  ...
  80037e:	68 5c 1e 80 00       	push   $0x801e5c
  800383:	6a 3a                	push   $0x3a
  800385:	68 50 1e 80 00       	push   $0x801e50
  ...
  8003f1:	68 b0 1e 80 00       	push   $0x801eb0
  8003f6:	6a 44                	push   $0x44
  8003f8:	68 50 1e 80 00       	push   $0x801e50
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8005c7:	e8 ac 13 00 00       	call   801978 <__udivdi3>
  ...
  800615:	52                   	push   %edx
  800616:	50                   	push   %eax
  800617:	e8 6c 14 00 00       	call   801a88 <__umoddi3>
  80061c:	83 c4 10             	add    $0x10,%esp
  80061f:	05 14 21 80 00       	add    $0x802114,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800772:	8b 04 85 38 21 80 00 	mov    0x802138(,%eax,4),%eax
  ...
  800853:	8b 34 9d 80 1f 80 00 	mov    0x801f80(,%ebx,4),%esi
  80085a:	85 f6                	test   %esi,%esi
  80085c:	75 19                	jne    800877 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  80085e:	53                   	push   %ebx
  80085f:	68 25 21 80 00       	push   $0x802125
  ...
  800872:	e9 5b 02 00 00       	jmp    800ad2 <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800877:	56                   	push   %esi
  800878:	68 2e 21 80 00       	push   $0x80212e
  ...
  8008a3:	75 05                	jne    8008aa <vprintfmt+0x1a6>
				p = "(null)";
  8008a5:	be 31 21 80 00       	mov    $0x802131,%esi
			if (width > 0 && padc != '-')
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  801966:	52                   	push   %edx
  801967:	50                   	push   %eax
  801968:	6a 2e                	push   $0x2e
  80196a:	e8 5b fa ff ff       	call   8013ca <syscall>
