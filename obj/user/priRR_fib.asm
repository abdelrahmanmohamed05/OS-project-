...
libmain(int argc, char **argv)
{
  ...
  800100:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  ...
  8001d9:	8b 90 ac 05 00 00    	mov    0x5ac(%eax),%edx
  8001df:	a1 20 30 80 00       	mov    0x803020,%eax
  8001e4:	8b 80 9c 05 00 00    	mov    0x59c(%eax),%eax
  ...
  800201:	8b 88 c0 05 00 00    	mov    0x5c0(%eax),%ecx
  800207:	a1 20 30 80 00       	mov    0x803020,%eax
  80020c:	8b 90 bc 05 00 00    	mov    0x5bc(%eax),%edx
  ...
  800232:	8b 80 c4 05 00 00    	mov    0x5c4(%eax),%eax
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  8019e3:	e8 5b fa ff ff       	call   801443 <syscall>
