...
libmain(int argc, char **argv)
{
  ...
  800083:	a3 60 30 80 00       	mov    %eax,0x803060

	//SET THE PROGRAM NAME
	if (myEnv->prog_name[0] != '\0')
  800088:	a1 60 30 80 00       	mov    0x803060,%eax
  80008d:	8a 40 20             	mov    0x20(%eax),%al
  800090:	84 c0                	test   %al,%al
  800092:	74 0d                	je     8000a1 <libmain+0x4f>
		binaryname = myEnv->prog_name;
  800094:	a1 60 30 80 00       	mov    0x803060,%eax
  800099:	83 c0 20             	add    $0x20,%eax
  80009c:	a3 50 30 80 00       	mov    %eax,0x803050
  ...
  8000ac:	a3 50 30 80 00       	mov    %eax,0x803050
  ...
  8000bf:	83 c4 10             	add    $0x10,%esp
	...
	if (printStats)
  8000c2:	a1 4c 30 80 00       	mov    0x80304c,%eax
  ...
  8000d5:	bb 14 1d 80 00       	mov    $0x801d14,%ebx
  ...
  80011a:	68 34 1c 80 00       	push   $0x801c34
  ...
  800136:	50                   	push   %eax
  800137:	68 5c 1c 80 00       	push   $0x801c5c
  ...
  800146:	a1 60 30 80 00       	mov    0x803060,%eax
  80014b:	8b 90 ac 05 00 00    	mov    0x5ac(%eax),%edx
  800151:	a1 60 30 80 00       	mov    0x803060,%eax
  800156:	8b 80 9c 05 00 00    	mov    0x59c(%eax),%eax
  80015c:	83 ec 04             	sub    $0x4,%esp
  80015f:	52                   	push   %edx
  800160:	50                   	push   %eax
  800161:	68 80 1c 80 00       	push   $0x801c80
  800166:	e8 65 03 00 00       	call   8004d0 <cprintf>
  80016b:	83 c4 10             	add    $0x10,%esp
				cprintf("# PAGE IN (from disk) = %d, # PAGE OUT (on disk) = %d, # NEW PAGE ADDED (on disk) = %d\n", myEnv->nPageIn, myEnv->nPageOut,myEnv->nNewPageAdded);
  80016e:	a1 60 30 80 00       	mov    0x803060,%eax
  800173:	8b 88 c0 05 00 00    	mov    0x5c0(%eax),%ecx
  800179:	a1 60 30 80 00       	mov    0x803060,%eax
  80017e:	8b 90 bc 05 00 00    	mov    0x5bc(%eax),%edx
  800184:	a1 60 30 80 00       	mov    0x803060,%eax
  800189:	8b 80 b8 05 00 00    	mov    0x5b8(%eax),%eax
  80018f:	51                   	push   %ecx
  800190:	52                   	push   %edx
  800191:	50                   	push   %eax
  800192:	68 a8 1c 80 00       	push   $0x801ca8
  800197:	e8 34 03 00 00       	call   8004d0 <cprintf>
  80019c:	83 c4 10             	add    $0x10,%esp
			}
			//cprintf("Num of freeing scarce memory = %d, freeing full working set = %d\n", myEnv->freeingScarceMemCounter, myEnv->freeingFullWSCounter);
			cprintf("Num of clocks = %d\n", myEnv->nClocks);
  80019f:	a1 60 30 80 00       	mov    0x803060,%eax
  8001a4:	8b 80 c4 05 00 00    	mov    0x5c4(%eax),%eax
  8001aa:	83 ec 08             	sub    $0x8,%esp
  8001ad:	50                   	push   %eax
  8001ae:	68 00 1d 80 00       	push   $0x801d00
  8001b3:	e8 18 03 00 00       	call   8004d0 <cprintf>
  8001b8:	83 c4 10             	add    $0x10,%esp
			cprintf("**************************************\n");
  8001bb:	83 ec 0c             	sub    $0xc,%esp
  8001be:	68 34 1c 80 00       	push   $0x801c34
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800265:	68 a8 1d 80 00       	push   $0x801da8
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800294:	68 ac 1d 80 00       	push   $0x801dac
  800299:	6a 26                	push   $0x26
  80029b:	68 f8 1d 80 00       	push   $0x801df8
  ...
  8002e5:	a1 60 30 80 00       	mov    0x803060,%eax
  ...
  800305:	a1 60 30 80 00       	mov    0x803060,%eax
  ...
  80034e:	a1 60 30 80 00       	mov    0x803060,%eax
  ...
  800369:	68 04 1e 80 00       	push   $0x801e04
  80036e:	6a 3a                	push   $0x3a
  800370:	68 f8 1d 80 00       	push   $0x801df8
  ...
  800399:	a1 60 30 80 00       	mov    0x803060,%eax
  ...
  8003bf:	a1 60 30 80 00       	mov    0x803060,%eax
  ...
  8003dc:	68 58 1e 80 00       	push   $0x801e58
  8003e1:	6a 44                	push   $0x44
  8003e3:	68 f8 1d 80 00       	push   $0x801df8
...
static void putch(int ch, struct printbuf *b) {
  ...
  80041c:	8b 15 7c 71 82 00    	mov    0x82717c,%edx
  800422:	a0 84 30 80 00       	mov    0x803084,%al
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800495:	83 c4 10             	add    $0x10,%esp
	sys_cputs(b.buf, b.idx, printProgName, curTextClr);
  800498:	8b 15 7c 71 82 00    	mov    0x82717c,%edx
  80049e:	a0 84 30 80 00       	mov    0x803084,%al
  ...
  8004be:	83 c4 10             	add    $0x10,%esp
	...
	printProgName = 0;
  8004c1:	c6 05 84 30 80 00 00 	movb   $0x0,0x803084
	return b.cnt;
...
int cprintf(const char *fmt, ...) {
  ...
  8004d3:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  8004d6:	c6 05 84 30 80 00 01 	movb   $0x1,0x803084
	va_start(ap, fmt);
...
int cprintf_colored(int textClr, const char *fmt, ...) {
  ...
  800500:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  800503:	c6 05 84 30 80 00 01 	movb   $0x1,0x803084
	curTextClr = (textClr << 8) ; //set text color by the given value
  80050a:	8b 45 08             	mov    0x8(%ebp),%eax
  80050d:	c1 e0 08             	shl    $0x8,%eax
  800510:	a3 7c 71 82 00       	mov    %eax,0x82717c
	va_start(ap, fmt);
  ...
  800533:	c7 05 7c 71 82 00 00 	movl   $0x700,0x82717c
  80053a:	07 00 00 
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80060a:	05 d4 20 80 00       	add    $0x8020d4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80075d:	8b 04 85 f8 20 80 00 	mov    0x8020f8(,%eax,4),%eax
  ...
  80083e:	8b 34 9d 40 1f 80 00 	mov    0x801f40(,%ebx,4),%esi
  800845:	85 f6                	test   %esi,%esi
  800847:	75 19                	jne    800862 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800849:	53                   	push   %ebx
  80084a:	68 e5 20 80 00       	push   $0x8020e5
  ...
  80085d:	e9 5b 02 00 00       	jmp    800abd <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800862:	56                   	push   %esi
  800863:	68 ee 20 80 00       	push   $0x8020ee
  ...
  80088e:	75 05                	jne    800895 <vprintfmt+0x1a6>
				p = "(null)";
  800890:	be f1 20 80 00       	mov    $0x8020f1,%esi
			if (width > 0 && padc != '-')
  ...
  800a86:	eb 35                	jmp    800abd <vprintfmt+0x3ce>
		...
		case '~':
			printProgName = 0;
  800a88:	c6 05 84 30 80 00 00 	movb   $0x0,0x803084
			break;
  800a8f:	eb 2c                	jmp    800abd <vprintfmt+0x3ce>
		// Print Program Name & UD
		case '@':
			printProgName = 1;
  800a91:	c6 05 84 30 80 00 01 	movb   $0x1,0x803084
			break;
...
uint32 sys_get_uheap_strategy()
{
  ...
  801825:	a3 c0 70 82 00       	mov    %eax,0x8270c0
	return uheapPlaceStrategy ;
  80182a:	a1 c0 70 82 00       	mov    0x8270c0,%eax
}
  80182f:	c9                   	leave  
  801830:	c3                   	ret    
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801837:	a3 c0 70 82 00       	mov    %eax,0x8270c0
...
void sys_env_set_priority(int32 envID, int priority)
{
  ...
  801955:	e8 5b fa ff ff       	call   8013b5 <syscall>
